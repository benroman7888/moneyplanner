const CACHE="money-planner-v6";
self.addEventListener("install",e=>{self.skipWaiting();e.waitUntil(caches.open(CACHE).then(c=>c.addAll(["./","./?v=6","./index.html","./manifest.json","./icon-192.png","./icon-512.png"]))) });
